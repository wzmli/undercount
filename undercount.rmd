...
getstat <- function(scenario, stat, rnd = 3) as.numeric(round(summ[summ$Scenario == scenario, stat], rnd))
c_prop <- c(high = getstat("high", "reportProp"), low = getstat("low", "reportProp"))
