...
We simulated a discrete-time deterministic SIR epidemic, applied two different ascertainment ratios ($a = \{0.2, 0.8\}$) to derive two time series of case reports, and used the `asymptor` package [@grusonAsymptor2020] which implements the authors' formula (including bias corrections) to estimate hidden cases (Figure 1).
