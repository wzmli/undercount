...
Maruotti *et al* 2022 used a mark-recapture formulalated approach to estimate bounds on true number of Monkeypox infections in most affected countries. We believe these approaches are fundametally flawed and that it is impossible to estimate solely on reported cases. We ran a simple simulation example using a Richards curve to validate the boundaries of the proposed method and that it is unrelated to the true ascertainment ratio and should not be applied to disease outbreak incidence data.
