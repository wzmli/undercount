...
\label{eq:richards}
\end{equation}
where $K$ is the final size of the epidemic, $h$ determines the inflection point, and $r$ is the initial growth rate.
