...
rpcall("med.plot_cuminf.Rout plot_cuminf.R med.est_cuminf.rda parameters.rda")
rpcall("high.plot_cuminf.Rout plot_cuminf.R high.est_cuminf.rda parameters.rda")
rpcall("low.plot_cuminf.Rout plot_cuminf.R low.est_cuminf.rda parameters.rda")
